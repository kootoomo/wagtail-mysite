...
class BlogChildPagesSerializer(Field):
    def to_representation(self, child_pages):
        ...
        # The same as above but in more pythonic way:
        return [
            {
                'id': child.id,
                'title': child.title,
...
class BlogListingPage(RoutablePageMixin, Page):
    ...
    api_fields = [
        ...
        # The same as above but more pretty name "posts":
    ...
    def get_context(self, request, *args, **kwargs):
        # Adding custom stuff to the context
    ...
    def latest_blog_posts_only_shows_last_5(self, request, *args, **kwarg):
...
class BlogDetailPage(Page):
    ...
    def save(self, *args, **kwargs):
        ...
        # DOESN'T WORK - DELETE CACHEing MENUS ITEMS
        # key = make_template_fragment_key(
        #     "navigation",
        # )
        # cache.delete(key)
